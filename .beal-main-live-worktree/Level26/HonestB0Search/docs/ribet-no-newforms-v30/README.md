...
See [`Ribet_No_Newforms_32_v30.md`](Ribet_No_Newforms_32_v30.md).
Concept DOI `10.5281/zenodo.22379293`. Foundations
`v0.30-mcom-structural-verification` at `2b60ccd`.
Parent Tate / Néron / Frey 13-isogeny / abstract Ribet /

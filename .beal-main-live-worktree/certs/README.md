...
v30 structural-verification notes for the four inhabited
finals. JSON pins stay unchanged (`full=1` `new=1`
`level16=0` `sturm=8`). Concept DOI `10.5281/zenodo.22379293`.

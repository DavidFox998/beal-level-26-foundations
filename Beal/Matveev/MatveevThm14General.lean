...
Gap-6 A⁴+B⁴=(B+6)¹³ no-go in BealGap6.lean
(baker_bound_gap6_unconditional_nogo; B odd A even; 3∣B
impossible by 3-descent like f1cb039; 5∣B compatible;
hGen_gap6/hLLL_gap6 stay def Prop).
Gap-7 A⁴+B⁴=(B+7)¹³ no-go in BealGap7.lean
(baker_bound_gap7_unconditional_nogo; B even A odd; 3∣B
compatible like gap-1/4; 5∣B impossible C≡2; 7∣B
impossible by 7-descent; hGen_gap7/hLLL_gap7 stay def Prop).
Gap-8 A⁴+B⁴=(B+8)¹³ no-go in BealGap8.lean
(baker_bound_gap8_unconditional_nogo; B odd A even; even B
dies after nine /2 residue 8; 3∣B impossible C≡2; 5∣B
impossible C≡3; 7∣B compatible C≡1; hGen_gap8/hLLL_gap8
stay def Prop).
Gap-9 A⁴+B⁴=(B+9)¹³ no-go in BealGap9.lean
...
stay def Prop).
Gap-12 A⁴+B⁴=(B+12)¹³ no-go in BealGap12.lean
(baker_bound_gap12_unconditional_nogo; B odd A even; even B
dies after six /2 last 4(16B6+3)¹³ residue 12; 3∣B
...
stay def Prop).
Gap-14 A⁴+B⁴=(B+14)¹³ no-go in BealGap14.lean
(baker_bound_gap14_unconditional_nogo; B odd A even; even B
dies after three /2 last 2(4B3+7)¹³ residue 6 or 14; 3∣B
impossible C≡2; 5∣B impossible C≡4; 7∣B impossible by
7-descent C1=B1+2; remaining coprime Darmon–Merel;
hGen_gap14/hLLL_gap14 stay def Prop).
Gap-15 A⁴+B⁴=(B+15)¹³ no-go in BealGap15.lean
(baker_bound_gap15_unconditional_nogo; B even A odd; 3∣B
impossible by 3-descent C1=B1+5≡2 last 27X; 5∣B impossible
...
#check BealGap6.baker_bound_gap6_unconditional_nogo
#check BealGap6.hGen_gap6
#check BealGap6.hLLL_gap6
#check BealGap6.hGen_exp_lt_ratio_gap6
#check BealGap6.hLLL_method_fails_gap6
#check BealGap6.baker_bound_gap6_true
#check BealGap6.gcd_A_B_eq_one_of_sol
#check BealGap6.B_odd_of_sol_gap6
#check BealGap6.A_even_of_sol_gap6
#check BealGap6.no_sol_when_three_dvd_B_gap6
#check BealGap6.no_sol_when_even_B
#check BealGap7.baker_bound_gap7_unconditional_nogo
#check BealGap7.hGen_gap7
#check BealGap7.hLLL_gap7
#check BealGap7.hGen_exp_lt_ratio_gap7
#check BealGap7.hLLL_method_fails_gap7
#check BealGap7.baker_bound_gap7_true
#check BealGap7.gcd_A_B_eq_one_of_sol
#check BealGap7.B_even_of_sol_gap7
#check BealGap7.A_odd_of_sol_gap7
#check BealGap7.no_sol_when_five_dvd_B_gap7
#check BealGap7.no_sol_when_seven_dvd_B_gap7
#check BealGap8.baker_bound_gap8_unconditional_nogo
#check BealGap8.hGen_gap8
#check BealGap8.hLLL_gap8
#check BealGap8.hGen_exp_lt_ratio_gap8
#check BealGap8.hLLL_method_fails_gap8
#check BealGap8.baker_bound_gap8_true
#check BealGap8.gcd_A_B_eq_one_of_sol
#check BealGap8.B_odd_of_sol_gap8
#check BealGap8.A_even_of_sol_gap8
#check BealGap8.no_sol_when_three_dvd_B_gap8
#check BealGap8.no_sol_when_five_dvd_B_gap8
#check BealGap8.no_sol_when_even_B
#check BealGap9.baker_bound_gap9_unconditional_nogo
#check BealGap9.hGen_gap9
#check BealGap9.hLLL_gap9
#check BealGap9.hGen_exp_lt_ratio_gap9
#check BealGap9.hLLL_method_fails_gap9
#check BealGap9.baker_bound_gap9_true
#check BealGap9.gcd_A_B_eq_one_of_sol
#check BealGap9.B_even_of_sol_gap9
...
#check BealGap12.baker_bound_gap12_unconditional_nogo
#check BealGap12.hGen_gap12
#check BealGap12.hLLL_gap12
#check BealGap12.hGen_exp_lt_ratio_gap12
#check BealGap12.hLLL_method_fails_gap12
#check BealGap12.baker_bound_gap12_true
#check BealGap12.gcd_A_B_eq_one_of_sol
#check BealGap12.B_odd_of_sol_gap12
#check BealGap12.A_even_of_sol_gap12
#check BealGap12.no_sol_when_even_B
...
#check BealGap14.baker_bound_gap14_unconditional_nogo
#check BealGap14.hGen_gap14
#check BealGap14.hLLL_gap14
#check BealGap14.hGen_exp_lt_ratio_gap14
#check BealGap14.hLLL_method_fails_gap14
#check BealGap14.baker_bound_gap14_true
#check BealGap14.gcd_A_B_eq_one_of_sol
#check BealGap14.B_odd_of_sol_gap14
#check BealGap14.A_even_of_sol_gap14
#check BealGap14.no_sol_when_even_B
#check BealGap14.no_sol_when_three_dvd_B_gap14
#check BealGap14.no_sol_when_five_dvd_B_gap14
#check BealGap14.seven_dvd_B_forces_seven_dvd_A_gap14
#check BealGap14.no_sol_when_seven_dvd_B_gap14
#check BealGap15.baker_bound_gap15_unconditional_nogo
#check BealGap15.hGen_gap15
#check BealGap15.hLLL_gap15
#check BealGap15.hGen_exp_lt_ratio_gap15
#check BealGap15.hLLL_method_fails_gap15
#check BealGap15.baker_bound_gap15_true
#check BealGap15.gcd_A_B_eq_one_of_sol
#check BealGap15.B_even_of_sol_gap15
#check BealGap15.A_odd_of_sol_gap15
#check BealGap15.three_dvd_B_forces_three_dvd_A_gap15
#check BealGap15.no_sol_when_three_dvd_B_gap15
...
#print axioms BealGap6.baker_bound_gap6_unconditional_nogo
#print axioms BealGap6.hGen_exp_lt_ratio_gap6
#print axioms BealGap6.hLLL_method_fails_gap6
#print axioms BealGap6.baker_bound_gap6_true
#print axioms BealGap6.no_gap6_of_axiom
#print axioms BealGap7.baker_bound_gap7_unconditional_nogo
#print axioms BealGap7.hGen_exp_lt_ratio_gap7
#print axioms BealGap7.hLLL_method_fails_gap7
#print axioms BealGap7.baker_bound_gap7_true
#print axioms BealGap7.no_gap7_of_axiom
#print axioms BealGap8.baker_bound_gap8_unconditional_nogo
#print axioms BealGap8.hGen_exp_lt_ratio_gap8
#print axioms BealGap8.hLLL_method_fails_gap8
#print axioms BealGap8.baker_bound_gap8_true
#print axioms BealGap8.no_gap8_of_axiom
#print axioms BealGap9.baker_bound_gap9_unconditional_nogo
#print axioms BealGap9.hGen_exp_lt_ratio_gap9
...
#print axioms BealGap12.baker_bound_gap12_unconditional_nogo
#print axioms BealGap12.hGen_exp_lt_ratio_gap12
...
#print axioms BealGap14.baker_bound_gap14_unconditional_nogo
#print axioms BealGap14.hGen_exp_lt_ratio_gap14
#print axioms BealGap14.hLLL_method_fails_gap14
#print axioms BealGap14.baker_bound_gap14_true
#print axioms BealGap14.no_gap14_of_axiom
#print axioms BealGap15.baker_bound_gap15_unconditional_nogo
#print axioms BealGap15.hGen_exp_lt_ratio_gap15

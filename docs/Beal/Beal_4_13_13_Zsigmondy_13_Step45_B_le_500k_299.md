# v8.50.0-B-le-500k-1498-rows Zsigmondy Step 45

`lean/BealLevel26Foundations/Beal_4_13_13_Zsigmondy_13_Step45_B_le_500k_299.lean`

Extends the B<=400000 table (1199 named
gap-3 pairs, including the inhabited
outlier (200000, 200003) with Pratt
p=12186951011) to 1498 named rows with
B<=500000 (C=B+3).  Inherited Step44
rows are wrapped.  The 299 new rows
in (400000, 500000] are sampled evenly
...
First new row (400001, 400004) p=53.
Named endpoint (500000, 500003) p=547.
Distribution of the sampled 299:
53:128, 79:63, 131:41, 157:36, 313:10,
521:8, 443:7, 547:6.
...
| Name | Status |
|---|---|
| `S_has_prime_with_exp_one_B_le_500000_table_rows` | inhabited (1498 rows) |
| `exists_p_with_order_ne_13_B_le_500000_from_exp_one_table_rows` | inhabited (1498 rows) |
| `S_not_fourth_B_le_500000_from_exp_one_table_rows` | inhabited (1498 rows) |
| `row_400001_400004` | inhabited (p=53) |
| `row_500000_500003` | inhabited (p=547) |
...
| `bugeaud_P_phi13_gt_C_when_B_gt_500000` | uninhabited |
| `rad_S_gt_sqrt_13_C12_when_squarefull_B_gt_500000` | uninhabited |

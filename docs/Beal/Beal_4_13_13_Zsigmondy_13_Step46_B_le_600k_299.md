# v8.51.0-B-le-600k-1797-rows Zsigmondy Step 46

`lean/BealLevel26Foundations/Beal_4_13_13_Zsigmondy_13_Step46_B_le_600k_299.lean`

Extends the B<=500000 table (1498 named
gap-3 pairs, including the inhabited
outlier (200000, 200003) with Pratt
p=12186951011) to 1797 named rows with
B<=600000 (C=B+3).  Inherited Step45
rows are wrapped.  The 299 new rows
in (500000, 600000] are sampled evenly
from the 50339-row pool of B with a
...
First new row (500003, 500006) p=79.
Named endpoint (600000, 600003) p=53.
Distribution of the sampled 299:
53:139, 79:71, 131:33, 157:19, 313:12,
443:12, 521:7, 547:6.
...
This is not every `B <= 600000`.
`exists_p_with_order_ne_13_mod_p_sq_inhabited`
stays a Prop.  `B > 600000` squarefull
...
| Name | Status |
|---|---|
| `S_has_prime_with_exp_one_B_le_600000_table_rows` | inhabited (1797 rows) |
| `exists_p_with_order_ne_13_B_le_600000_from_exp_one_table_rows` | inhabited (1797 rows) |
| `S_not_fourth_B_le_600000_from_exp_one_table_rows` | inhabited (1797 rows) |
| `row_500003_500006` | inhabited (p=79) |
| `row_600000_600003` | inhabited (p=53) |
...
| `bugeaud_P_phi13_gt_C_when_B_gt_600000` | uninhabited |
| `rad_S_gt_sqrt_13_C12_when_squarefull_B_gt_600000` | uninhabited |

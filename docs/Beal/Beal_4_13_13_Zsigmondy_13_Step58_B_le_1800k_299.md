...
First new row (1700007,1700010) p=53.
Named last row (1800000,1800003) p=79.
B=1800000 is in the pool.
Distribution of the sampled 299:
53:127, 79:79, 131:41, 157:22, 313:13, 443:7, 521:5, 547:5.
...
This is not every `B <= 1800000`.
`exists_p_with_order_ne_13_mod_p_sq_inhabited`
stays a Prop.  `B > 1800000` squarefull
...
| Name | Status |
|---|---|
| `S_has_prime_with_exp_one_B_le_1800000_table_rows` | inhabited (5385 rows) |
| `exists_p_with_order_ne_13_B_le_1800000_from_exp_one_table_rows` | inhabited (5385 rows) |
| `S_not_fourth_B_le_1800000_from_exp_one_table_rows` | inhabited (5385 rows) |
| `row_1700007_1700010` | inhabited (p=53) |
| `row_1800000_1800003` | inhabited (p=79) |
...
| `bugeaud_P_phi13_gt_C_when_B_gt_1800000` | uninhabited |
| `rad_S_gt_sqrt_13_C12_when_squarefull_B_gt_1800000` | uninhabited |

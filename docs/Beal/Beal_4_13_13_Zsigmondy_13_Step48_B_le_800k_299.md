# v8.53.0-B-le-800k-2395-rows Zsigmondy Step 48

`lean/BealLevel26Foundations/Beal_4_13_13_Zsigmondy_13_Step48_B_le_800k_299.lean`

Extends the B<=700000 table (2096 named
gap-3 pairs, including the inhabited
outlier (200000, 200003) with Pratt
p=12186951011) to 2395 named rows with
B<=800000 (C=B+3).  Inherited Step47
rows are wrapped.  The 299 new rows
in (700000, 800000] are sampled evenly
...
53:137, 79:74, 131:36, 157:24, 521:8,
547:8, 313:6, 443:6.
...
This is not every `B <= 800000`.
`exists_p_with_order_ne_13_mod_p_sq_inhabited`
stays a Prop.  `B > 800000` squarefull
...
| Name | Status |
|---|---|
| `S_has_prime_with_exp_one_B_le_800000_table_rows` | inhabited (2395 rows) |
| `exists_p_with_order_ne_13_B_le_800000_from_exp_one_table_rows` | inhabited (2395 rows) |
| `S_not_fourth_B_le_800000_from_exp_one_table_rows` | inhabited (2395 rows) |
| `row_700001_700004` | inhabited (p=131) |
| `row_800000_800003` | inhabited (p=53) |
...
| `bugeaud_P_phi13_gt_C_when_B_gt_800000` | uninhabited |
| `rad_S_gt_sqrt_13_C12_when_squarefull_B_gt_800000` | uninhabited |

...
Mazur-chain docs. Lean sources live in
[`lean/BealLevel26Foundations/Mazur/`](../../lean/BealLevel26Foundations/Mazur/README.md).
`hGeomForbid_typed_true` uses `X0_26_cusps` `P.mem` lemmas.

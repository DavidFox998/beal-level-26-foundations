...
The Beal Conjecture is its own chamber of *Opera Numerorum* — not a "route" of the Riemann Hypothesis work below. It is built across two companion repositories: a conditionally complete assembly, and its computable level-26 foundations.

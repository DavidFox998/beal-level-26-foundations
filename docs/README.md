...
**Current as of** tag `v4.1.1-descent-compute` (git tag
...
| Path | Contents |
|---|---|
| [`releases/`](releases/README.md) | One note per tagged Foundations release, from `v1.0.0-computable` through `v4.1.1-descent-compute` |

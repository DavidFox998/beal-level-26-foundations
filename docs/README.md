...
**Current as of** tag `v4.0.2-selmer` (commit `c2f829d`, version DOI
...
| Path | Contents |
|---|---|
| [`releases/`](releases/README.md) | One note per tagged Foundations release, from `v1.0.0-computable` through `v4.0.2-selmer` |

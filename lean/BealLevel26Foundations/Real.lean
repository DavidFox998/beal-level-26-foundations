...
This entrypoint gathers the unconditional Frey invariant algebra, executable
level-26 genus arithmetic, and q-expansion matrix calculation. It does not
claim the unavailable Tate-conductor, modular-curve Riemann--Hurwitz, or
Picard/Abel--Jacobi comparison theorems.
-/

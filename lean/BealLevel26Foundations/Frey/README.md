...
| `../Beal/FullProof/RibetMazur.lean` | `q_expansion_26a1`/`26b1` + `mazur_principle_step`; `ribet_iterated_arrow` stays a Prop | Not `ExistsNewformLevel2` (`0 ≠ 0`); not `¬ PositiveBealTriple` |

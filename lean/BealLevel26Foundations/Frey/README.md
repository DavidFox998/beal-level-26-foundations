...
| `../Beal/FullProof/RibetMazur.lean` | `fermat_four_lemma` + `FermatFourCase` (FLT4 for power-of-2 exponents); `TWAuxEll` search `Q₁ ≡ 1 [MOD ℓ]` | Not `ExistsNewformLevel2` (`0 ≠ 0`); not unconditional Beal `∀` |

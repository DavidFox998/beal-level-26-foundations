...
| `../Beal/FullProof/BealForallProof.lean` | Glue of Tate + Ribet + GeometryBridge; positive-bases Beal from the missing newform arrow | Unguarded sketch is false (`0³+1³=1³`); none-chain sketch stays uninhabited; not a journal Beal proof |

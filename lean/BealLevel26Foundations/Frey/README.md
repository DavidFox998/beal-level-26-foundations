...
| `../Beal/FullProof/RibetMazur.lean` | `frey_a_q_real` via `(-c₆/q)=±1`; `J0_N_real` ModSym token; Mazur only when `13 ∣ v_q(Δ)` | Not `ExistsNewformLevel2` (`0 ≠ 0`); not `¬ PositiveBealTriple` |

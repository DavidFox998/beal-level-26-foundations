...
| `../Beal/FullProof/TrueConductor.lean` | Mixed-exponent Frey model of a primitive Beal triple; `Δ`/`c₄` identities; true gcd ⇒ odd `q∣ABC` gives `v_q(c₄)=0`, `v_q(Δ)>0` | Not Tate/Kodaira; `frey_global_conductor` uninhabited |

...
**v8.39.0-B-le-50000-exp-one-real-witnesses — Beal (4,13,13) B<=50000 exp-one real witnesses (Track B). Track A: no new Beal-∀, unconditional Beal NOT claimed.**

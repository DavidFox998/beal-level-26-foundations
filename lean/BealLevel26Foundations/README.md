...
**v8.38.0-B-le-10000-exp-one-extension — Beal (4,13,13) B<=10000 exp-one extension (Track B). Track A: no new Beal-∀, unconditional Beal NOT claimed.**

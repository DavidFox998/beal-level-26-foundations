...
Main foundations library. **Current as of** `v4.0.9-fourCusps-forall`.
...
| [`Mazur/`](Mazur/README.md) | Genus certificates, four-premise endgame scaffold, v4.0.4 four-cusp package, v4.0.8 typed `hGeomForbid`, v4.0.9 cusp-point forall |

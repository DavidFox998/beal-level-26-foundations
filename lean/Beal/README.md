...
typed `hGeomForbid`, v4.0.9 cusp-point forall, v4.0.10 Chabauty-0 package, v4.0.11 residue-disk input, v4.0.12 scheme boundary, and v4.0.13 named `det ≠ 0` immersion.

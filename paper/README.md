...
## v30 structural-verification source (`main.tex`)

Mathematics of Computation manuscript — not an arXiv preprint.
Written from `beal-conjecture` `paper-v30-draft` (`2124501` from `ea261b9`).

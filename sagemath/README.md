...
| `foundations_doi_manifest.json` | v1.4.0 cert-bridge DOI, plus `latest_foundations_release` (now `v4.0.8-geom-forbid`; prior published `v4.0.7-hIdentify-j`) |
...
`v4.0.7-hIdentify`, `v4.0.7-hIdentify-j`, and `v4.0.8-geom-forbid`) do **not**

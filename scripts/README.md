...
|---|---|
| `verify-matveev-beal.sh` | Current CI / AMS referee surface: 0 `sorry`, `matveev_gap3_lower` is the B≤10^6 integer-gap close, `C1_floor=143186215390`, proved `gap3_A_bounds` and `matveev_product_bound_of_B_le_B0`, concept DOI `22379293`, slug `beal-level-26-foundations` |

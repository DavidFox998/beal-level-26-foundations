...
| v17 | [`10.5281/zenodo.22729067`](https://doi.org/10.5281/zenodo.22729067) | `3fbafa6` | PARI `qflll` `B0_raw → B0_reduced=1e6` `baker_B0_reduction_certificate.json` `List (List Int)` decide no axioms |

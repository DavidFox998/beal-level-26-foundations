...
# Beal Level 26 Foundations — v8.64.0-B-le-1900k-5684-rows

**v8.64.0-B-le-1900k-5684-rows — Track A lock. Track A: no new Beal-∀, unconditional Beal NOT claimed.**
...
- Houseclean mint [10.5281/zenodo.22654189](https://doi.org/10.5281/zenodo.22654189)
  (`v8.19.9-fourth-power-residue` / `v8.64.0-B-le-1900k-5684-rows`) under hook `22379293`.
...
- Inhabited: `S_has_prime_with_exp_one_B_le_1900000_table_rows`,
...
HEAD also has Track B `v8.64.0-B-le-1900k-5684-rows`
(5684 named `B ≤ 1900000` gap-3 exp-one
rows, including inherited outlier
`(200000,200003)` p=12186951011 and
new-window last row `(1899995,1899998)`
p=443; s2_26 pack still
coefficient check not Ribet;
`kraus_elimination_q_13_level_26` stays a Prop;
`B > 1900000` Bugeaud / rad stay

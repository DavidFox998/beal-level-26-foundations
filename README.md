...
- `LLL_basis_det` / `LLL_v_mem` / `LLL_v_norm_lt_thirty_two` /
  ...
  not raise `|Λ|`. Conditional SVT and the Baker–Davenport
  rearrangement are theorems; reduced-basis existence stays
  `def Prop`

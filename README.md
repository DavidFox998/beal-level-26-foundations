...
- v24.2.2-Beal-44-13-Level-26-Matveev-Log-One-Plus-Le `matveev_log_one_plus_le_self`, `matveev_gap3_B_pow_div_A_pow_pos`, `matveev_gap3_abs_lambda_nonneg`, `matveev_gap3_abs_lambda_le_ratio`, `matveev_gap3_abs_lambda_lt_one_of_small_ratio`; target and `baker_bound_gap3` stay uninhabited; locked Lean 0 vs v24.2.1 `ac100cf` except `BealMatveevThm14.lean` and `RibetMazur.lean`; DOI `10.5281/zenodo.22731508`

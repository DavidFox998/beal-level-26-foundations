...
- Zenodo DOI [`10.5281/zenodo.22729309`](https://doi.org/10.5281/zenodo.22729309) (concept [`10.5281/zenodo.22379293`](https://doi.org/10.5281/zenodo.22379293); previous v18 [`10.5281/zenodo.22729129`](https://doi.org/10.5281/zenodo.22729129))
...
- v19.0.0-Beal-44-13-Level-26-Matveev-Constants-Formalization `matveev_C1_floor=143186215390` explicit Nat; `matveev_C1_pos` / `matveev_explicit_gap3_constants_hold` by decide (no axioms); `matveev_height_B0=C1_floor*30^{n+3}`; Tate c4 scale 16; `baker_bound_gap3` stays def Prop; locked Lean 0 vs v18 `430189e`; DOI `10.5281/zenodo.22729309` (concept `10.5281/zenodo.22379293`)

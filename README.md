[![v4.0.1-jacobian-skeleton DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.22312844.svg)](https://doi.org/10.5281/zenodo.22312844)
...
| v4.0.2-selmer S-unit audit versus genuine 2-Selmer | `v4.0.2-selmer` | pending version DOI | `Jacobian/TwoSelmer_vs_SUnits_26` audits the eight S-unit indices from the v1.4.0 decomposition cert, proves the finite audit retains all eight and is not a singleton, and therefore is not genuine cohomological 2-Selmer. `MwrankCertificateSoundness_26` packages Sage `certified_mwrank = 0` for `26a` and `26b` with the `s₁,s₂` model and `a₂ = -1` versus `1`. Not a Mathlib Jacobian or MW theorem. Ledger still v1.4.0 `0259fe957cc348b7286e233ce717fac47c30ad174b05e8e1c5fb70626f511151`. |

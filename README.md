...
lake build BealMatveevBealV25B0Search  # B<1000 + LLLTargetB8 + Gap3B0Million + C1'≤8 nogo + Frey (4,4,13) + Level32Table + Level928Table + Ribet29C_Lowering + Ribet29C_Residue16 + Ribet29C_Residue16_L23 + MazurIrreducibility13 + Inertia29Unramified + SerreImage13
```

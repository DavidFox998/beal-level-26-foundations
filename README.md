...
# Beal Level 26 Foundations — v8.22.1-X0-2q-Darmon-Merel-plan

**v8.22.1-X0-2q-Darmon-Merel-plan — Track A lock. Track A: no new Beal-∀, unconditional Beal NOT claimed.**
...
- Houseclean mint [10.5281/zenodo.22654189](https://doi.org/10.5281/zenodo.22654189)
  (`v8.19.9-fourth-power-residue` / `v8.22.1-X0-2q-Darmon-Merel-plan`) under hook `22379293`.
...
- Track B odd-A ladder (4,13,13): v8.19.6 `B ≤ 100` with `C = B+1` and
  ...
  `2 · rad(oddPart_rec A)`.
- Inhabited: `oddPart_rec`, `rad`, `oddPart_def`, `rad_dvd_pow`,
  ...
  `B_le_100_closed`.
- Uninhabited: `kraus_criterion_q_ne_13`, `X0_2q_no_Frey_match`,
...
HEAD also has Track B `v8.22.1-X0-2q-Darmon-Merel-plan`
(oddPart/rad and `2q` radical inhabited; Kraus / X₀(2q) matching stay uninhabited);

...
- v15.0.0-Baker-B0-PARI-Certificate PARI gp Matveev 2000 Thm 1.4 / BMS Table 1 integer cert `baker_B0_PARI=1000000` and `baker_B0_certificate.json`; `baker_B0_certificate_holds` by decide (no axioms); `baker_bound_gap3` stays def Prop; Tate / Baker-upper-bound 0 lines vs v14 `3089bec`; v14 displayed J0/mwrank/formal certs unchanged; DOI `10.5281/zenodo.22728624` (concept `10.5281/zenodo.22379293`)

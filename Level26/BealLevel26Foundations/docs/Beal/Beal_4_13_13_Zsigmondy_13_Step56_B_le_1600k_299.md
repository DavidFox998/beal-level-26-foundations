# v8.61.0-B-le-1600k-4787-rows Zsigmondy Step 56

`lean/BealLevel26Foundations/Beal/FullProof/Beal_4_13_13_Zsigmondy_13_Step56_B_le_1600k_299.lean`

Extends the B<=1500000 table (4488 named
gap-3 pairs, including the inhabited
outlier (200000, 200003) with Pratt
p=12186951011) to 4787 named rows with
B<=1600000 (C=B+3).  Inherited Step55
rows are wrapped.  The 299 new rows
in (1500000, 1600000] are sampled evenly
from the 50310-row pool of B with a
...
First new row (1500003,1500006) p=443.
Named last row (1600000,1600003) p=79.
B=1600000 is in the pool.
Distribution of the sampled 299:
53:137, 79:72, 131:28, 157:29, 313:12, 443:9, 521:5, 547:7.
...
This is not every `B <= 1600000`.
`exists_p_with_order_ne_13_mod_p_sq_inhabited`
stays a Prop.  `B > 1600000` squarefull
...
| Name | Status |
|---|---|
| `S_has_prime_with_exp_one_B_le_1600000_table_rows` | inhabited (4787 rows) |
| `exists_p_with_order_ne_13_B_le_1600000_from_exp_one_table_rows` | inhabited (4787 rows) |
| `S_not_fourth_B_le_1600000_from_exp_one_table_rows` | inhabited (4787 rows) |
| `row_1500003_1500006` | inhabited (p=443) |
| `row_1600000_1600003` | inhabited (p=79) |
...
| `bugeaud_P_phi13_gt_C_when_B_gt_1600000` | uninhabited |
| `rad_S_gt_sqrt_13_C12_when_squarefull_B_gt_1600000` | uninhabited |
